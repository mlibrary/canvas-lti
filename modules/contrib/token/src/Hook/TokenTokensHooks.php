        ...
        switch ($name) {
          ...
          default:
            ...
            // For example [current-page:node:nid].
              ...
              $entity_tokens = $this->token->findWithPrefix($tokens, $entity_type);
              ...
              $replacements += $this->token->generate($token_type, $entity_tokens, [$token_type => $entity], $options, $bubbleable_metadata);
            }
