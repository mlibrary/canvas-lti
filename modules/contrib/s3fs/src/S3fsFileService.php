 ...
 *
 * @deprecated in s3fs:8.x-3.5 and is removed from s3fs:4.0.0. This class is
 *   not replaced and should not be used with drupal/core >=10.3.
 * @see https://www.drupal.org/project/s3fs/issues/3447227
 */
