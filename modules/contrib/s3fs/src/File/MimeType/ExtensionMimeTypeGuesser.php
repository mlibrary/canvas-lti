...
namespace Drupal\s3fs\File\MimeType;
 ...
 *
 * This file is copied/modified from core to avoid calling
 * FileSystemInterface::baseName() which causes container circular reference
 * errors.
 *
 * @see https://www.drupal.org/project/s3fs/issues/3529457
 * @see https://git.drupalcode.org/project/drupal/-/blob/fb4a6c4c1fdbec40ad7fad014feabaf0067716c9/core/lib/Drupal/Core/File/MimeType/ExtensionMimeTypeGuesser.php
 */
final class ExtensionMimeTypeGuesser implements MimeTypeGuesserInterface {
  ...
  public function guessMimeType($path): ?string {
    ...
    $extension = '';
    $file_parts = explode('.', $this->basename($path));
    ...
    // Drupal Core < 10.0 Proxy Class for MimeTypeGuesser has wrong return
    // type hint forcing a string return.
   ...
   * with a non-US-ASCII character, at least on 5.0.0-7.4.33.
   *
   * @see https://www.drupal.org/project/s3fs/issues/3529457
   * @see https://git.drupalcode.org/project/drupal/-/blob/fb4a6c4c1fdbec40ad7fad014feabaf0067716c9/core/lib/Drupal/Core/File/FileSystem.php
   * @see http://bugs.php.net/bug.php?id=37738
   * @see basename()
   */
  private function basename(string $uri, ?string $suffix = NULL): string {
    $separators = '/';
    ...
    if ($filename == NULL) {
      ...
      throw new \Exception('preg_replace experience error in Class: ' . __CLASS__ . ' method: ' . __METHOD__);
    }
    return $filename;
  }
